...
const ConditionNahor = () => {
  ...
  return (
    <div className="ConditionNahor-container">
      <div className="ConditionNahor-img">
        <div>
      ...
      <div className="ConditionNahor-content">
        {sentenses.map((sentense) => {
          return (
            <div className="ConditionNahor-item">
              <h3>{sentense.title}</h3>
              <p>{sentense.paragraph}</p>
            </div>
          );
        })}
      </div>
